...
2. `python -c "from kflash.theme import get_theme; t = get_theme(); print(t.phase, t.marker_new, t.marker_blk, t.menu_border)"` shows non-empty ANSI codes (in color-capable terminal)
</verification>
