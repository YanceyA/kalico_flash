...
3. **Menu rendering function:**
   ...
   - **Menu order per CONTEXT.md decision:** Setup-first order: Add, List, Flash, Remove, Settings, Exit
     (Note: CONTEXT.md is authoritative for implementation decisions made during discuss-phase.
     This order prioritizes new user onboarding flow.)
